...
public partial class TraoDoiMuaBan : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserName, "UQ__Account__C9F284569A27DA98").IsUnique();
        ...
        {
            entity.HasKey(e => e.IDProduct).HasName("PK__Inventor__4290D179CB6DDAB5");
        ...
        {
            entity.HasKey(e => e.IDShop).HasName("PK__Shop__C52550288C3159E8");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__User__3214EC27BDED6809");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__hellowor__3213E83F91C8952C");
